defmodule QuieroSaber.ParticipantControllerTest do
  use QuieroSaber.ConnCase
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    ...
    participant = Repo.get_by!(Participant, @valid_attrs)
    assert redirected_to(conn) == participant_path(conn, :show, participant.id)
  end
